...
class TestSkillValidator:
    ...
    def test_too_many_rules(self, validator, valid_skill):
        ...
        valid_skill["rules"] = [
            f"Rule {i+1} with enough characters to be valid" for i in range(15)
        ]
        is_valid, errors, warnings = validator.validate_skill(valid_skill)
    ...
    def test_item_too_short(self, validator, valid_skill):
        ...
        valid_skill["rules"] = [
            "Short",
            "This is a valid rule item with enough characters for testing",
        ]
        is_valid, errors, warnings = validator.validate_skill(valid_skill)
    ...
    def test_item_too_long(self, validator, valid_skill):
        ...
        valid_skill["rules"] = [
            "x" * 200,
            "This is a normal rule with enough characters",
        ]
        is_valid, errors, warnings = validator.validate_skill(valid_skill)
